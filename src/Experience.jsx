...
export default function Experience() {
  ...
  return (
    <>
      ...
      <div className="tips" style={style(welcome)}>🏓 Click on any area to start playing ball</div>
      <a className='github' href='https://github.com/ibra-kdbra/PingPong-3D' target='_blank' rel='noreferrer'>
        ...
        <span className='author'>ibra-kdbra</span>
      </a>
    </>
  );
}
